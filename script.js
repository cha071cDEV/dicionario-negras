function carregaDicionario() {
    var biografias = {
        bio01: {
            ...
            foto: "https://i.postimg.cc/8fS8KSGX/marielle-franco.png",
        ...
        bio02: {
            nome: "Lélia Gonzalez",
            foto: "https://i.postimg.cc/2q1f3GTG/lelia-gonzalez.png",
        ...
        bio03: {
            nome: "Angela Davis",
            foto: "https://i.postimg.cc/LJ6SF21r/angela-davis.png",
            ...
            quote: "Não aceito mais as coisas que não posso mudar, estou mudando as coisas que não posso aceitar.",
        },
        bio04: {
            nome: "Conceição Evaristo",
            foto: "https://i.postimg.cc/Z9XzNNMS/conceicao-evaristo.png",
        ...
        bio05: {
            ...
            foto: "https://i.postimg.cc/Fdc5VKMJ/carolina-de-jesus.png",
        ...
        bio06: {
            nome: "Rosa Parks",
            foto: "https://i.postimg.cc/K1q2Zw74/rosa-parks.png",
    ...
    for (var bio in biografias) {
        content.innerHTML +=
            ...
            '</p>' +
            '<blockquote> <q>' +
                biografias[bio].quote +
            '</q> </bloquote> </details> </div>'
    };
}
